...
import {
  fetchProduct,
  showMoreProducts,
} from "../../../store/slice/allProductsSlice";
...
export default function ProductsContainer() {
  const visibleProducts = useSelector(
    (state) => state.allProductsSlice.visibleProducts
  );
  ...
  useEffect(() => {
    dispatch(
      filterItems({ minValue: +minValue || 0, maxValue: +maxValue || Infinity })
    );
    ...
    <section className={s.container}>
      ...
      <div className={s.container_form}>
        ...
        <div className={s.container_form_item}>
          <div className={s.container_form_item_subheader}>
            Discounted items
          </div>
          <input
            type="checkbox"
        ...
        <div className={s.container_form_sorted}>
          ...
          <select
            ...
            className={s.container_form_sorted_input}
          >
      ...
      <div className={s.container_block}>
        ...
        <div>
          {visibleProducts < products.length && (
            <button onClick={handleShowMore} className={s.container_block_btn}>
              More
            </button>
          )}
        </div>
